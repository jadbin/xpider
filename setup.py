...
def read_version():
    p = join(dirname(__file__), 'xpider', '__init__.py')
...
def main():
    ...
    setup(
        ...
        url="https://github.com/jadbin/xpider",
        description="Selenium based web scraping framework",
        ...
        entry_points={
            "console_scripts": ["xpider = xpider.cmdline:main"]
        },
